...
public class Main {
    ...
    // Method 1 for confirming whether the given password conforms to
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        final String regex = String.format("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\" +
                "d).{%d,}$", minLength);
    ...
    public static List<String> extractEmails(String str) {
        ...
        final Pattern pattern = Pattern.compile("[a-zA-Z0-9.]+(@mail\\" +
